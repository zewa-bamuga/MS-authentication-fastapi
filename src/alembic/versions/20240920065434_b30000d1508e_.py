...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["avatar_attachment_id"], ["attachment.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("email"),
    )
    op.create_index(
        op.f("ix_user_avatar_attachment_id"),
        "user",
    ...
    op.create_index(
        op.f("ix_password_reset_code_user_id"),
        "password_reset_code",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_table("token")
    op.drop_index(
        op.f("ix_password_reset_code_user_id"), table_name="password_reset_code"
    )
